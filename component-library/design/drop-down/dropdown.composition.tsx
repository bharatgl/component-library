...
import { menuTransition } from '@bharatgl/component-library.design.styles.trasitions.menu-transition';
import { hoverable } from '@bharatgl/component-library.design.styles.characters.hoverable';
